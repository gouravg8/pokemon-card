...
const Card = ({
  ...
  return (
    <div className="border-2 border-gray-400 w-full flex flex-col justify-center items-center gap-4 rounded-md p-4 hover:transform hover:scale-105 duration-300 hover:cursor-pointer">
